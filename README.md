...
```cpp
void hobbies() {
    std::cout << "Security Research" << std::endl;
    std::cout << "Penetration Testing" << std::endl;
    std::cout << "Reading Books & Documentation" << std::endl;
    std::cout << "Asking Questions" << std::endl;
    std::cout << "Hiding From My Cats ಠ_ಠ" << std::endl;
}
```
